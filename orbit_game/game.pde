...
void runStart() {
     println("this is runStart");
    // nothing to do here
}

void exitStart() {
    println("this is exitStart");
    // nothing to do here
}
...
void runPlaying() {
    ...
    print("this is hotBalloonVertVelocity: ");
    println(this.hotBalloonVertVelocity);
    print("this is hotBalloonVertVelocityFinal: ");
    println(hotBalloonVertVelocityFinal);
...
void runOver() {
    println("this is runOver");
    // nothing to do
}

void exitOver() {
    println("this is exitOver");
    // nothing to do
}
